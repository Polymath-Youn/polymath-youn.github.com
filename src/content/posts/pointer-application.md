...
postSlug: "pointer-application"
featured: false
draft: false
tags:
  - c
  - programming
description: "The pointer concept is simple, but the use case is confusing, so let's look at a few simple functions. The first is when you use an incremen..."
---
