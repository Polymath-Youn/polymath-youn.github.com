...
tags:
  ...
  - programming
  - algorithm
description: "Of the various algorithms for sorting elements in an array, Simple sort is the simplest. Simple sort is in principle the same as Bubble sort..."
---
