...
tags:
  - c
  - programming
description: "이전 post에서는 정해진 크기 변수형과 함께 선언하여 사용하는 배열array 형태를 살펴봤었다. 하지만 이렇게 배열의 크기를 정해서 일정 공간의 메모리를 사용하는 정적 메모리 할당 방법은 한정적인 크기를 유지하면서 사용해야한다는 점에서 메모리가 낭비..."
---
